...
ACHIEVEMENTS: tuple[AchievementDefinition, ...] = (
    ...
    AchievementDefinition("peak_force_50", "best_peak_force_n", 500, 90),
    AchievementDefinition("peak_force_100", "best_peak_force_n", 1000, 100),
    AchievementDefinition("peak_force_150", "best_peak_force_n", 1300, 110),
    AchievementDefinition("peak_force_200", "best_peak_force_n", 1600, 120),
    AchievementDefinition("avg_force_30", "best_avg_force_n", 500, 130),
    AchievementDefinition("avg_force_60", "best_avg_force_n", 800, 140),
    AchievementDefinition("avg_force_90", "best_avg_force_n", 1000, 150),
    AchievementDefinition("avg_force_120", "best_avg_force_n", 1200, 160),
